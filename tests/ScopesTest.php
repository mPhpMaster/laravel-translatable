...
final class ScopesTest extends TestCase
{
    ...
    {
        app()->setLocale('de');
        app('config')->set('laravel-translatable.load_translations_when_to_array', false);
    ...
    {
        app('config')->set('laravel-translatable.fallback_locale', 'en');
        app('config')->set('laravel-translatable.load_translations_when_to_array', false);
        app()->setLocale('de');
    ...
    {
        app()->setLocale('de');
        app('config')->set('laravel-translatable.load_translations_when_to_array', true);
    ...
    {
        app('config')->set('laravel-translatable.fallback_locale', 'de');
        app('config')->set('laravel-translatable.use_fallback', true);
