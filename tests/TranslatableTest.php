...
use mPhpMaster\Translatable\Locales;
use mPhpMaster\Translatable\Tests\Eloquent\Country;
use mPhpMaster\Translatable\Tests\Eloquent\CountryStrict;
use mPhpMaster\Translatable\Tests\Eloquent\CountryTranslation;
use mPhpMaster\Translatable\Tests\Eloquent\Person;
use mPhpMaster\Translatable\Tests\Eloquent\Vegetable;
use mPhpMaster\Translatable\Tests\Eloquent\VegetableTranslation;
...
final class TranslatableTest extends TestCase
{
    ...
    {
        $this->app->make('config')->set('laravel-translatable.translation_model_namespace', 'App\Models\Translations');
    ...
    {
        $this->app->make('config')->set('laravel-translatable.translation_suffix', 'Trans');

        static::assertEquals(
            'mPhpMaster\Translatable\Tests\Eloquent\VegetableTrans',
    ...
    {
        $this->app->make('config')->set('laravel-translatable.fallback_locale', 'de');
    ...
    {
        $this->app->make('config')->set('laravel-translatable.fallback_locale', 'de');
        $this->app->make('config')->set('laravel-translatable.use_fallback', true);
    ...
    {
        $this->app->make('config')->set('laravel-translatable.fallback_locale', 'ch');
    ...
    {
        $this->app->make('config')->set('laravel-translatable.fallback_locale', 'en');
    ...
    {
        $this->app->make('config')->set('laravel-translatable.locale_key', 'language_id');
    ...
    public function config_overrides_apps_locale(): void
    {
        ...
        App::make('config')->set('laravel-translatable.locale', 'de');
    ...
    {
        $this->app->make('config')->set('translatable.load_translations_when_to_array', false);
