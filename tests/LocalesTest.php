...
use mPhpMaster\Translatable\Exception\LocalesNotDefinedException;
...
final class LocalesTest extends TestCase
{
    ...
    public function locales_is_declared_as_a_singleton_instance(): void
    {
        ...
        static::assertEquals($singletonHash, spl_object_hash($this->app->make('laravel-translatable.locales')));
    ...
    {
        $this->app['config']->set('laravel-translatable.locales', [
            'de',
        ]);
        $this->app->make('laravel-translatable.locales')->load();
        static::assertEquals(['de'], $this->app->make('laravel-translatable.locales')->all());
        ...
        static::assertEquals(['de'], $this->app->make('laravel-translatable.locales')->all());
        $this->app->make('laravel-translatable.locales')->load();
        static::assertEquals(['de', 'en'], $this->app->make('laravel-translatable.locales')->all());
    }
    ...
    public function all_language_locales_are_loaded_from_the_configuration(): void
    {
        ...
        static::assertEquals(['el', 'en', 'fr', 'de', 'id'], $this->app->make('laravel-translatable.locales')->all());
    }
    ...
    public function it_loads_locales_and_countries(): void
    {
        ...
        static::assertEquals(['en', 'en-GB', 'en-US', 'de', 'de-DE', 'de-CH'], $this->app->make('laravel-translatable.locales')->all());
    }
    ...
    public function can_return_locales_as_array(): void
    {
        ...
        static::assertEquals(['el', 'en', 'fr', 'de', 'id'], $this->app->make('laravel-translatable.locales')->toArray());
    }

    /** @test */
    public function can_retrieve_current_configuration(): void
    {
        $this->app['config']->set('laravel-translatable.locale', 'de');

        static::assertEquals('de', $this->app->make('laravel-translatable.locales')->current());
    }

    /** @test */
    public function current_can_return_the_translator_locale_if_configuration_is_empty(): void
    {
        $this->app['config']->set('laravel-translatable.locale', null);
