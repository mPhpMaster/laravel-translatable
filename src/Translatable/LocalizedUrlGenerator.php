...
class LocalizedUrlGenerator
{
     ...
     * Detect the locale.
     *
     * @param \mPhpMaster\Translatable\UrlBuilder $url
     *
     * @return string
     */
    ...
    {
        return Config::get('laravel-translatable.omit_url_prefix_for_locale', null);
    }
    ...
    {
        return Config::get('laravel-translatable.supported-locales', []);
    }
}
