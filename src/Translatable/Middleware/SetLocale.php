...
namespace mPhpMaster\Translatable\Middleware;

use Closure;
use mPhpMaster\Translatable\LocaleHandler;
...
class SetLocale
{
    ...
    protected function getLocaleFromFallbackRoute(\Illuminate\Http\Request $request)
    {
        ...
        $omittedLocale = Config::get('laravel-translatable.omit_url_prefix_for_locale');
    ...
    {
        $locales = Config::get('laravel-translatable.supported-locales', []);
