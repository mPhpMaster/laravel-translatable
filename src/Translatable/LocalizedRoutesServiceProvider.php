...
use mPhpMaster\Translatable\Macros\IsLocalizedMacro;
use mPhpMaster\Translatable\Macros\LocalizedHasMacro;
use mPhpMaster\Translatable\Macros\LocalizedUrlMacro;
use mPhpMaster\Translatable\Macros\UriTranslationMacro;
use mPhpMaster\Translatable\Macros\LocalizedRoutesMacro;
...
class LocalizedRoutesServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $name = 'laravel-translatable';
    ...
    protected function registerLocaleHandler()
    {
        $this->app->bind(LocaleHandler::class, function ($app) {
            $supportedLocales = $app['config']->get('laravel-translatable.supported-locales', []);
            $useLocalizer = $app['config']->get('laravel-translatable.use_localizer', false);
