...
namespace mPhpMaster\Translatable\Traits;
...
trait Relationship
{
    ...
    public function getTranslationModelNameDefault(): string
    {
        ...
        return $modelName.config('laravel-translatable.translation_suffix', 'Translation');
    }
    ...
    {
        return config('laravel-translatable.translation_model_namespace');
    }
