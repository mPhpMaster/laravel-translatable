...
class Locales implements Arrayable, ArrayAccess
{
    ...
    {
        return $this->config->get('laravel-translatable.locale') ?: $this->translator->getLocale();
    }
    ...
    {
        return $this->config->get('laravel-translatable.locale_separator') ?: '-';
    }
    ...
    {
        $localesConfig = (array) $this->config->get('laravel-translatable.locales', []);
