...
namespace mPhpMaster\Translatable\Validation;
...
class RuleFactory
{
    ...
    {
        $this->format = $format ?? $config->get('laravel-translatable.rule_factory.format');
        $this->prefix = $prefix ?? $config->get('laravel-translatable.rule_factory.prefix');
        $this->suffix = $suffix ?? $config->get('laravel-translatable.rule_factory.suffix');
    }
